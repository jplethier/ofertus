  ...
  describe 'should show the new deal form', :js => true do
    ...
    it 'should show the form fields' do
      within "#sem-col .ct-inputs-login form#new_deal" do
        should have_css('div label', :for => 'deal_title', :text => 'Título')
        should have_css('div input#deal_title', :type => :text)
        should have_css('div label', :for => 'deal_real_price')
        should have_css('div input#deal_real_price_mask.money', :type => :text)
        should have_css('div label', :for => 'deal_price')
        should have_css('div input#deal_price_mask.money', :type => :text)
        should have_css('div label', :for => 'deal_category', :text => 'Categoria')
        should have_css('div select#deal_category')
        should have_css('div select#deal_category option', :text => 'Selecione')
        should have_css('div select#deal_category option', :text => 'Alimentação', :value => "1")
        should have_css('div select#deal_category option', :text => 'Beleza e Saúde', :value => "2")
        ...
        should have_css('div select#deal_category option', :text => 'Casa e Decoração', :value => "10")
        should have_css('div select#deal_category option', :text => 'Entretenimento e Lazer', :value => "11")
        should have_css('div label', :for => 'deal_description', :text => 'Descrição')
        ...
        should have_css('div input#deal_image_url', :type => :text)
        should have_css('div label', :for => "deal_company", :text => 'Empresa Anunciante')
        should have_css('div input#deal_company', :type => :text)
        should have_css('div label', :for => "deal_city_id")
        should have_css('div select#deal_city_id')
      end
    end
  end
