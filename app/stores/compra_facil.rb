...
class CompraFacil
  ...
  def self.fill_deal_fields(link)
    ...
    deal.description = page.at_css("#produto-caracteristicas").try(:text).try(:strip)[0,1200] if page.at_css("#produto-caracteristicas") && page.at_css("#produto-caracteristicas").try(:text)
